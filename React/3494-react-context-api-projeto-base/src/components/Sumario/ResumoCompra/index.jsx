...
const ResumoCompra = () => {
  const { quantidadeTotal, quantidade } = useCarrinhoContext();
  return (
    <div className="bg-black p-4">
      ...
      <div className="d-flex flex-row justify-content-between">
        ...
        <span>{formatadorMoeda(quantidadeTotal)}</span>
      </div>
      <div className="divisor__verde my-3" />
      <div className="d-flex flex-row justify-content-between">
        <p className="verde-limao m-0">Total</p>
        <ValorFormatado className="verde-limao" valor={quantidadeTotal} />
      </div>
    </div>
  );
};
